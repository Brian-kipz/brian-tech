...
┃ 📋 *${prefix}menu* / *${prefix}help* - View command list
┃ 👤 *${prefix}owner* - Contact developer
┃ 📦 *${prefix}repo* / *${prefix}script* - View source code
┃
┗━━━━━━━━━━━━━━━━━━━━┈
`;
                await sock.sendMessage(chatId, { text: helpText.trim(), ...channelInfo }, { quoted: message });
            };
            ...
            switch (command) {
                ...
                case "script": {
                    const repoText = `
📂 *BRIAN-TECH SOURCE CODE*
─────────────────────
🤖 *Bot Name:* BRIAN-TECH 
💻 *Developer:* Brian Kimutai (Spiffydewizard)
📦 *Base:* Baileys Multi-Device (Node.js)

🚀 *Official GitHub Repository:*
https://github.com/Brian-kipz/brian-tech

_Feel free to fork, star ⭐, and customize your own bot instance!_
`.trim();
                    await sock.sendMessage(from, { text: repoText, ...channelInfo }, { quoted: msg });
                    commandExecuted = true;
                    break;
                }
...
// Export the message handler module for your main file
